    ...
    <md-table v-model="searched" md-sort="name" md-sort-order="asc" md-card md-fixed-header>
      <md-table-toolbar>
        <div class="md-toolbar-section-start">
          <h1 class="md-title">Tabela de Usuários</h1>
        </div>

        <md-field md-clearable class="md-toolbar-section-end">
          <md-input placeholder="Procurar" v-model="search" @input="searchOnTable" />
        </md-field>
      </md-table-toolbar>
      ...
      <md-table-row slot="md-table-row" slot-scope="{ item }">
        ...
        <md-table-cell md-label="Comida" md-sort-by="gender">{{ item.gender }}</md-table-cell>
